...
static void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = HEARTBEAT_LED_Pin|D1_AIN1_Pin|D1_BIN1_Pin|D1_BIN2_Pin
                          |D2_BIN2_Pin|D2_BIN1_Pin;
  ...
  GPIO_InitStruct.Pin = D1_AIN2_Pin|D2_STBY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : D1_STBY_Pin D2_AIN1_Pin D2_AIN2_Pin CAN2_RS_Pin
                           RF_EN_Pin */
  GPIO_InitStruct.Pin = D1_STBY_Pin|D2_AIN1_Pin|D2_AIN2_Pin|CAN2_RS_Pin
                          |RF_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : D2_MOTORA_CHA_Pin D2_MOTORA_CHB_Pin */
  GPIO_InitStruct.Pin = D2_MOTORA_CHA_Pin|D2_MOTORA_CHB_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : D2_MOTORB_CHA_Pin D2_MOTORB_CHB_Pin */
  GPIO_InitStruct.Pin = D2_MOTORB_CHA_Pin|D2_MOTORB_CHB_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
